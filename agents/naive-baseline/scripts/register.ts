...
async function main(): Promise<void> {
  ...
  const metadata = {
    name: "Naive Baseline",
    description:
      "Control baseline agent. Forecasts next = last observed value (persistence) with a volatility-widened 95% band. The benchmark every model is measured against on the leaderboard.",
