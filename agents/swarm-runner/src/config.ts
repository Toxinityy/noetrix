...
import { parseStrategy, type StrategyKey } from "./strategy.js";
...
export function loadConfig(): SwarmRunnerConfig {
  ...
  return {
    ...
    addresses,
    categories: [
      { label: "METH_APR_24H", syntheticCenter: 350, syntheticDriftPpm: 800 }, // ~3.5% APR bps (domain [0,2000])
